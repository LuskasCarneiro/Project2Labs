...
class interfaceAtaxx():
    ...
    def clicar(self, event):
        ...
        posicao_logica = [int(posicao_grelha[0]/self.division_size(self.mk.matrix_size,values.canva_size)),int(posicao_grelha[1]/self.division_size(self.mk.matrix_size,values.canva_size))]
